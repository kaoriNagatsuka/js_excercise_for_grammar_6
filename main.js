...
//ブロックスコープとは、{}で括られたもの（if文など）の中で書かれた関数や変数は同じ{}内からのみアクセス可能なもののことを指します。
// そのため、{}内に書かれた変数などを{}外で使用することはできません。これにより、外部から上書きされる可能性が低くなります。
// const,letはブロックスコープに該当します。
...
kadai_3('kaori', function (message) {
    alert(message);
});
